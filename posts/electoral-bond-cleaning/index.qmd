...
x <- setdiff(df_buyer$Bond.Number,df_party$Bond.Number)
print(length(x))
x

print ("Party encashed bonds not in buyer")
y <- setdiff(df_party$Bond.Number, df_buyer$Bond.Number)
print(length(y))
y
...
print(paste("Purchased - Encashed: ", z))

rmultinom(z)
```

9.  Consolidating based on Names and Dates

### Step 5: Merging the files

### Step 6: Cleaning Names

1.  Cleaning variable/column names
